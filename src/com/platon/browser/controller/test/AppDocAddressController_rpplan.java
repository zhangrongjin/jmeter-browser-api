...
public class AppDocAddressController_rpplan extends AbstractJavaSamplerClient {

	
	public Arguments getDefaultParameters() {
		Arguments params = new Arguments();
		params.addArgument("url", "http://192.168.16.173:9061/browser-server/address/rpplanDetail");
	...
	public static void main(String[] args) {
		...
		AppDocAddressController_rpplan test = new AppDocAddressController_rpplan();
		test.setupTest(arg0);
