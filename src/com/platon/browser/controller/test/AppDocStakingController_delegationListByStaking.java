...
public class AppDocStakingController_delegationListByStaking extends AbstractJavaSamplerClient {

	public Arguments getDefaultParameters() {
		Arguments params = new Arguments();
		params.addArgument("url", "http://192.168.16.173:9061/browser-server/staking/delegationListByStaking");
		...
		params.addArgument("body.stakingBlockNum", "304");
		return params;
	}
