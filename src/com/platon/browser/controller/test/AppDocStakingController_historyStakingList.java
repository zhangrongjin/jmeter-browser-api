...
public class AppDocStakingController_historyStakingList extends AbstractJavaSamplerClient {

	public Arguments getDefaultParameters() {
		Arguments params = new Arguments();
		params.addArgument("url", "http://192.168.16.173:9061/browser-server/staking/historyStakingList");
		params.addArgument("body.pageNo", "1");
		params.addArgument("body.pageSize", "10");
		params.addArgument("body.key", "platon.node.1");
		return params;
	}
