...
public class AppDocTransactionController_transactionListByAddress extends AbstractJavaSamplerClient {

	public Arguments getDefaultParameters() {
		Arguments params = new Arguments();
		params.addArgument("url", "http://192.168.16.173:9061/browser-server/transaction/transactionListByAddress");
		params.addArgument("body.pageNo", "1");
		params.addArgument("body.pageSize", "10");
		params.addArgument("body.address", "0x2e95e3ce0a54951eb9a99152a6d5827872dfb4fd");
		return params;
	}
